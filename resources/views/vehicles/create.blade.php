...
<div class="container">
    ...
    <form action="{{ route('vehicles.store') }}" method="POST">
        ...
        <div class="form-group">
            <label for="numseri">Numéro de Série</label>
            <input type="text" id="numseri" name="numseri" class="form-control" required>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <select id="client_id" name="client_id" class="form-control">
                ...
                @foreach($clients as $client)
                    <option value="{{ $client->id }}" class="a">{{ $client->nom }} , {{ $client->prenom }} </option>
                @endforeach
            </select>
        </div>

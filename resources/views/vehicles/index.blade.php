            ...
            <table class="table">
                ...
                <tbody>
                    @foreach($vehicles as $vehicle)
                        <tr>
                            <td>{{ $vehicle->numseri }}</td>
                            <td>{{ $vehicle->model }}</td>
                            <td >{{ $vehicle->marque }}</td>
                            <td class="a">{{ $vehicle->client->nom }}  {{ $vehicle->client->prenom }}</td>
                            <td>
                                <a href="{{ route('vehicles.edit', $vehicle->id) }}" class="btn btn-edit">Modifier</a>

...
<nav class="navbar-left">
    ...
    <div class="container">
        <div class="form-container">
            <h2 class="form-title">Modifier un Vehicule</h2>
            <form action="{{ route('vehicles.update', $vehicle->id) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="mb-3">
                    <label for="numseri" class="form-label">Numéro de Série</label>
                    <input type="text" class="form-control" id="numseri" name="numseri" value="{{ $vehicle->numseri }}" required>
                </div>
                <div class="mb-3">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="{{ route('vehicles.index') }}" class="btn btn-danger">Annuler</a>
                </div>
            </form>
        </div>
    </div>

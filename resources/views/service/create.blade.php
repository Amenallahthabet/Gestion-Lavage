...
<div class="container">
    <h2 class="form-title">Ajouter un Service</h2>
        ...
        <div class="form-group">
            ...
            <select id="tempservice" name="tempservice" class="form-control">
                ...
                @foreach($tempsOptions  as $option)
                    <option value="{{ $option }}" class="a">{{ $option }}</option>
                @endforeach
            </select>
        </div>

        <div class="form-group">
            <label for="prixservice">Prix de Service</label>
            <input type="number" id="prixservice" name="prixservice" class="form-control" required>
        </div>

        ...
        <table class="table">
            ...
            <tbody>
                @foreach($realisations as $realisation)
                    <tr>
                        <td>{{ $realisation->service->nom }}</td>
                        <td>{{ $realisation->vehicle->numseri }}</td>
                        <td>{{ $realisation->employe->nom }} {{ $realisation->employe->prenom }}</td>
                        <td>{{ $realisation->date_debut }}</td>
                        <td>{{ $realisation->temps_debut }}</td>
                        <td>{{ $realisation->temps_fin }}</td>
                        <td>
                            <a href="{{ route('realisations.edit', $realisation->id) }}" class="btn btn-edit">Modifier</a>
                            <form action="{{ route('realisations.destroy', $realisation->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
